...
/**
 * How much writing is in a note: words, characters, lines.
 *
 ...
 *
 * Pure Kotlin, no Android: three small rules that are easier to get wrong than they look, and a
 * JVM test is the cheapest place to pin them.
 */
data class Stats(val words: Int, val characters: Int, val lines: Int) {
    ...
    companion object {
         ...
         *
         * A body of nothing but whitespace is three zeros rather than one line of nothing.
         */
